...
/*   Updated: 2020/09/15 20:23:29 by hexa             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		prepare(char *str, size_t len, t_sha512 *data)
{
	...
	(*data).h[2] = 0x3c6ef372fe94f82b;
	(*data).h[3] = 0xa54ff53a5f1d36f1;
	(*data).h[4] = 0x510e527fade682d1;
	(*data).h[5] = 0x9b05688c2b3e6c1f;
	(*data).h[6] = 0x1f83d9abfb41bd6b;
	(*data).h[7] = 0x5be0cd19137e2179;
	(*data).i = 0;
	while ((*data).i < 80)
		(*data).w[(*data).i++] = (uint64_t)0;
	(*data).i = 0;
}
