...
{
	(*data).hash.fd = fd;
	(*data).h[0] = 0x8c3d37c819544da2;
	(*data).h[1] = 0x73e1996689dcd4d6;
	(*data).h[2] = 0x1dfab7ae32ff9c82;
	(*data).h[3] = 0x679dd514582f9fcf;
	(*data).h[4] = 0x0f6d2b697bd44da8;
	(*data).h[5] = 0x77e36f7304c48942;
	(*data).h[6] = 0x3f9d85a86a1d36c8;
	(*data).h[7] = 0x1112e6ad91d692a1;
	(*data).hash.i = 0;
...
char			ft_sha512_224(int fd, t_digest *digest)
{
	...
	while (data.hash.i < 8)
	{
		ft_memrcpy(ptr + (data.hash.i * 8), &(data.h[data.hash.i]), 8);
		data.hash.i++;
	}
	if (!((*digest).ptr = ft_memalloc(56)))
		return (0);
	ft_memcpy((*digest).ptr, ptr, 56);
	(*digest).size = 56;
	return (1);
}
